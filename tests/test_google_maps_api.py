...
from utils.api import Coogle_maps_api
...
class Test_create_place():
    ...
    def test_create_new_place(self):
        ...
        print("Method POST")
        result_post: Response = Coogle_maps_api.create_new_place()
        ...
        result_get: Response = Coogle_maps_api.get_new_place(place_id)
        ...
        print("Method PUT")
        result_put: Response = Coogle_maps_api.put_new_place(place_id)
        ...
        print("Method DELETE")
        result_delete: Response = Coogle_maps_api.delete_new_place(place_id)
        ...
        print("Testing for creating, updating and deleting a new location was successful!")
